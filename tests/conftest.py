...
def _copy(src: Path, dst: Path, data: dict) -> Path:
    full = {
        ...
        "modules": {"doc_drift_gate": False, "arch_onboarding": False, "feature_registry": False, "github_issues": False, "contracts_drift": False, "git_hooks": False, "contract_first": False},
    }
    full.update(data)
