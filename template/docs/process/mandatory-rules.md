...
5. **Tests prove acceptance.** Every feature or behavior change maps a test to the acceptance it claims. Exception: pure copy/formatting/doc-typo with no behavior change.
